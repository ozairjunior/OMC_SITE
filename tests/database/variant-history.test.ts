...
beforeAll(async () => {
  ...
  for (const name of [
    ...
    '20260729100000_add_search_indexes.sql',
    '20260729090000_add_product_helpers.sql',
    '20260731_fix_all_schema_and_rls.sql',
    '20260815090000_create_auth_profiles.sql',
    '20260815110000_operational_integrity.sql',
