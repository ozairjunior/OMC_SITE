-- Atualizacao de usuarios administrativos sem risco de deixar o painel sem admin.
BEGIN;
...
BEGIN
  ...
  -- Bloqueia a tabela logica inteira para que duas alteracoes concorrentes
  -- nao consigam remover o ultimo administrador ao mesmo tempo.
